...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ti.xml2json.js')
	...
	f = os.path.join(cwd,'Classes','TiXml2jsonModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','ti.xml2json.js']
